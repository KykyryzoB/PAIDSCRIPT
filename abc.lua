...
local Section = Tab:CreateSection("FIND ALL BIG MY EGGS")

local Button = Tab:CreateButton({
    Name = "FIND",
    Callback = function()
        for i,v in ipairs(workspace.EasterHuntEggs:GetDescendants()) do
...
elseif game.PlaceId == 129665246576996 then
    ...
    Tab:CreateButton({
        Name = "GET 1 GOLD EGG",
        Callback = function() 
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = workspace.TrialCompletedPoints["Trial 1"].root.CFrame
        end,
    })
    ...
    Tab:CreateButton({
        Name = "GET 2 GOLD EGG",
        Callback = function() 
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = workspace.TrialCompletedPoints["Trial 2"].root.CFrame
        end,
    })
    ...
    Tab:CreateButton({
        Name = "GET 3 GOLD EGG",
        Callback = function() 
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = workspace.TrialCompletedPoints["Trial 3"].root.CFrame
        end,
    })
